...
export function OrderConfirmation({
  ...
  if (status === "pending" && pixQrCode) {
    return (
      <div className="border-border bg-card flex flex-col items-center gap-6 rounded-xl border p-6 text-center shadow-sm">
        <div className="bg-yellow-500/10 flex h-16 w-16 items-center justify-center rounded-full">
          <Clock className="h-8 w-8 text-yellow-500" />
        </div>

        <div>
          <h2 className="text-foreground text-xl font-bold">Quase lá, {firstName}!</h2>
        ...
        <div className="bg-secondary w-full rounded-lg p-3">
          ...
          <p className="text-foreground break-all text-xs">{pixQrCode}</p>
          <button
        ...
        <p className="text-muted-foreground text-xs">
          Após o pagamento, seu pedido será confirmado automaticamente e o motoboy será acionado.
        </p>
      </div>
    )
  }
  ...
  return (
    <div className="border-border bg-card flex flex-col items-center gap-6 rounded-xl border p-6 text-center shadow-sm">
      <div className="bg-green-500/10 flex h-16 w-16 items-center justify-center rounded-full">
        <CheckCircle className="h-8 w-8 text-green-500" />
      </div>

      <div>
        <h2 className="text-foreground text-xl font-bold">Pedido confirmado, {firstName}! 🎉</h2>
        <p className="text-muted-foreground mt-1 text-sm">
      ...
      <div className="bg-secondary w-full rounded-lg p-4 text-left">
        <p className="text-foreground text-sm font-semibold">O que acontece agora?</p>
